...
const SvgMaskedIntro = () => {
  return (
    <svg width="1920" height="1080" viewBox="0 0 1920 1080" fill="none" xmlns="http://www.w3.org/2000/svg">
      <text className="title" x="50vw" y="55vh"  textAnchor="middle" display="block"  fill="#3F8D1A">
            murilo v.
          </text>
        ...
        <path id="maskedWavePath"
          ...
          <text clipPath="url(#maskedWave)" id="maskedTitle" className="title" x="50vw" y="55vh"  textAnchor="middle" display="block"  fill="#232323">
            murilo v.
          </text>
